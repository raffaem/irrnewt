...
void irr::newton::IMaterial::setCollisionCallback(
	...
	NewtonMaterialSetCollisionCallback(
		...
		irr::newton::Hidden::NewtonMaterialCollisionContactBegin,//contact begin
		irr::newton::Hidden::NewtonMaterialCollisionContactProcess,//contact process
		irr::newton::Hidden::NewtonMaterialCollisionContactEnd//contact end
		);
}
