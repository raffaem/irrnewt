...
namespace irr{
	namespace newton{
		...
		protected:
			...
			friend void  irr::newton::Hidden::defCharacterControllerForceAndTorqueCallback(const NewtonBody* body);
			friend void  irr::newton::Hidden::defCharacterControllerTransformCallback(const NewtonBody* body, const float* matrix);
