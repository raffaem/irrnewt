...
namespace irr{
	namespace newton{
		...
		namespace Hidden{
			...
			void defBodyForceAndTorqueCallback (const NewtonBody* n_body);
			...
			//camera callbacks
			void defCameraBodyTransformCallback(const NewtonBody* body, const float* matrix);
			void defCameraCharacterControllerTransformCallback(const NewtonBody* body, const float* matrix);
