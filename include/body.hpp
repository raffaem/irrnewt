...
namespace irr{
	namespace newton{
		...
		protected:
			...
			//callbacks
			friend void 
				irr::newton::Hidden::defBodyForceAndTorqueCallback (const NewtonBody* body);
			friend void
				irr::newton::Hidden::defBodyTransformCallback(const NewtonBody* body, const float* matrix);
			friend void
				irr::newton::Hidden::defRagDollForceCallback(const NewtonBody* body);
			friend void
				irr::newton::Hidden::defBodyForceAndTorqueCallback(newton::IBody* body, const NewtonBody* n_body);
